 ...
 */
final class Version20211110141322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE spent ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE spent ADD CONSTRAINT FK_F1653759A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_F1653759A76ED395 ON spent (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F1653759A76ED395 ON spent');
        $this->addSql('ALTER TABLE spent DROP user_id');
    }
}
